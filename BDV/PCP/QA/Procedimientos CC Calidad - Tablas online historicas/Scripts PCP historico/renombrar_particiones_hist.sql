-- =====================================================
-- SCRIPT COMPLETO: Renombrado automático de particiones HIST
-- Esquema: PCPH
...
-- Descripción: Renombra particiones SYS_Pxxx a:
--   - Para fechas: <TABLA>_YYYYMM (mensual)
--   - Para numérico: <TABLA>_<VALOR_INICIAL>
-- =====================================================
...
PROMPT   - ORDEN_DETAIL_HIST (numérico por ID_ORDEN)
PROMPT   - ORDEN_HIST (fecha mensual)
PROMPT   - DEBITS_HIST (fecha mensual)
PROMPT   - TRACK_ORDEN_HIST (numérico por ID_TRACK_ORDEN)
...
PROMPT
PROMPT =====================================================
PROMPT INICIANDO DESINSTALACIÓN (PCPH)
PROMPT =====================================================
